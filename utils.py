...
number_of_total_blocks_cache = TTLCache(maxsize=2, ttl=43200)
number_of_unique_users_blocked_cache = TTLCache(maxsize=2, ttl=43200)
number_of_unique_users_blocking_cache = TTLCache(maxsize=2, ttl=43200)
number_block_1_cache = TTLCache(maxsize=2, ttl=14400)
number_blocking_2_and_100_cache = TTLCache(maxsize=2, ttl=43200)
number_blocking_101_and_1000_cache = TTLCache(maxsize=2, ttl=43200)
number_blocking_greater_than_1000_cache = TTLCache(maxsize=2, ttl=43200)
average_number_of_blocking_cache = TTLCache(maxsize=2, ttl=43200)
number_blocked_1_cache = TTLCache(maxsize=2, ttl=43200)
number_blocked_2_and_100_cache = TTLCache(maxsize=2, ttl=43200)
number_blocked_101_and_1000_cache = TTLCache(maxsize=2, ttl=43200)
number_blocked_greater_than_1000_cache = TTLCache(maxsize=2, ttl=43200)
average_number_of_blocked_cache = TTLCache(maxsize=2, ttl=43200)
total_users_cache = TTLCache(maxsize=2, ttl=43200)
